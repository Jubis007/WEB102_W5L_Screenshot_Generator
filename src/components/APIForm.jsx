...
const APIForm = ({ inputs, handleChange, onSubmit }) => {
  // Descriptions to help the user understand what to type in each box
  const inputsInfo = [
    "Input a link to any website you would like to take a screenshot of. Do not include https or any protocol.",
  ...
  return (
    <div>
      ...
      <form className="form-container">
        {/* We use Object.entries to loop through our dictionary and generate a textbox for each key */}
        {inputs &&
